...
void direct2DManager::drawLine(ID2D1SolidColorBrush* brush, float startX, float startY, float endX, float endY, float strokeWidth)
{
	float x1 = startX;
	float y1 = startY;
	float x2 = endX;
...
void direct2DManager::drawRectangle(ID2D1SolidColorBrush* brush, float startX, float startY, float endX, float endY, float strokeWidth)				 
{
	float x1 = startX;
	float y1 = startY;
	float x2 = endX;
...
void direct2DManager::drawEllipse(ID2D1SolidColorBrush* brush, float startX, float startY, float endX, float endY, float strokeWidth)				 
{
	float x1 = startX;
	float y1 = startY;
	float x2 = endX;
...
void direct2DManager::fillRectangle(ID2D1SolidColorBrush* brush, float startX, float startY, float endX, float endY)										 
{
	float x1 = startX;
	float y1 = startY;
	float x2 = endX;
...
void direct2DManager::fillEllipse(ID2D1SolidColorBrush* brush, float startX, float startY, float endX, float endY)											 
{
