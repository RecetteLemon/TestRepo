...
public:
	...
	*/
	...
	//기본 출력
	void render(wstring strKey, float opacity);

	//원래 크기 - 키값, 그려줄 x좌표, y좌표, 투명도
	void render(wstring strKey, float destX, float destY, float opacity);

	//변형 크기 - 키값, 그려줄 x좌표, y좌표, 출력할 너비, 출력할 높이ㅡ 투명도
	void render(wstring strKey, float destX, float destY, int showWidth, int showHeight, float opacity);
	...
	void frameRender(wstring strKey, float destX, float destY, int currentFrameX, int currentFrameY, float opacity);

	//변형 크기 프레임렌더 - 키값, 그려줄 x, y 좌표, 출력할 너비, 출력할 높이, 가로 방향 프레임 인덱스, 세로 방향 프레임 인덱스, 투명도
	void frameRender(wstring strKey, float destX, float destY, int showWidth, int showHeight, int currentFrameX, int currentFrameY, float opacity);
