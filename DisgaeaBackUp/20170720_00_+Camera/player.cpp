...
void player::render(void) 
{
	...
	switch (_player.stat)
	{
		...
		case player::PLAYER_STAT_RT_STAND:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RT_STAND], true, 1.0f);
		break;
		case player::PLAYER_STAT_LB_STAND:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LB_STAND], true, 1.0f);
		break;
		case player::PLAYER_STAT_LT_STAND:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LT_STAND], true, 1.0f);
		break;
		case player::PLAYER_STAT_RB_STAND:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RB_STAND], true, 1.0f);
		break;

		//==================움직임====================//
		case player::PLAYER_STAT_RT_MOVE:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RT_MOVE], true, 1.0f);
		break;
		case player::PLAYER_STAT_LB_MOVE:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LB_MOVE], true, 1.0f);
		break;
		case player::PLAYER_STAT_LT_MOVE:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LT_MOVE], true, 1.0f);
		break;
		case player::PLAYER_STAT_RB_MOVE:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RB_MOVE], true, 1.0f);
		break;

		//==================공격함====================//
		case player::PLAYER_STAT_RT_ATTACK:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RT_ATTACK], true, 1.0f);
		break;
		case player::PLAYER_STAT_LB_ATTACK:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LB_ATTACK], true, 1.0f);
		break;
		case player::PLAYER_STAT_LT_ATTACK:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LT_ATTACK], true, 1.0f);
		break;
		case player::PLAYER_STAT_RB_ATTACK:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RB_ATTACK], true, 1.0f);
		break;

		//==================쳐맞음====================//
		case player::PLAYER_STAT_RT_HIT:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RT_HIT], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_LB_HIT:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LB_HIT], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_LT_HIT:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LT_HIT], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_RB_HIT:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RB_HIT], true, 1.0f);
		break;																		   
																					   
		//==================던진다====================//								 
		case player::PLAYER_STAT_RT_THROW:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RT_THROW], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_LB_THROW:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LB_THROW], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_LT_THROW:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LT_THROW], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_RB_THROW:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RB_THROW], true, 1.0f);
		break;																		   
																					   
		//==================쳐들다====================//								 
		case player::PLAYER_STAT_LB_LIFT:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LB_LIFT], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_LT_LIFT:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_LT_LIFT], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_RT_LIFT:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RT_LIFT], true, 1.0f);
		break;																		   
		case player::PLAYER_STAT_RB_LIFT:											   
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_RB_LIFT], true, 1.0f);
		break;																		   
	
		//==================스킬씀====================//
		case player::PLAYER_STAT_SKILL:
			_player.img->aniRender(_player.rc.left, _player.rc.top, _player.pos[PLAYER_POS_SKILL], true, 1.0f);
		break;
