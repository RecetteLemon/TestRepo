...
{
	this->render(destX, destY, ani->getFramePos().x, ani->getFramePos().y, ani->getFrameWidth(), ani->getFrameHeight(), opacity);
}

void image::aniRender(float destX, float destY, int showWidth, int showHeight, animation* ani, float opacity)
{
	this->render(destX, destY, showWidth, showHeight, ani->getFramePos().x, ani->getFramePos().y, ani->getFrameWidth(), ani->getFrameHeight(), opacity);
}
